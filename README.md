...
# Foto e audio
A [questo](https://github.com/LeddaZ/NastroAdesivoBot/blob/master/foto.txt) link si trovano tutte le foto utilizzate nel bot nell'ordine in cui appaiono in BusiFoto. A [questo](https://github.com/LeddaZ/NastroAdesivoBot/blob/master/audio.txt) si trovano i link per  i file audio utilizzati nel bot su OneDrive e la cartella con le lezioni complete su MEGA.
